...
class tgi_acf_field_ingredient_selector extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Ingredient Selector', 'tgi-acf-ingredient-selector');
		...
		*  var message = acf._e('ingredient_selector', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'tgi-acf-ingredient-selector'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','tgi-acf-ingredient-selector'),
			'instructions'	=> __('Customise the input font size','tgi-acf-ingredient-selector'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','tgi-acf-ingredient-selector'),
		}
