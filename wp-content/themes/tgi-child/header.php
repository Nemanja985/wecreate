...
// ADDED by rewel to mimic transparency of header
// if(is_page_template('recipe.php')){
// 	$transparency_markup = 'data-transparent-header="true" class="transparent'.$nectar_transparency_color_class;
// 	$starting_color = (empty($options['header-starting-color'])) ? '#ffffff' : $options['header-starting-color'];
				...
				<div class="col span_9 col_last">
					...
					if($sideWidgetArea == '1') { ?>
						...
						<ul class="buttons" data-user-set-ocm="off">
							<li id="search-btn" style="padding-bottom: 16px; padding-top: 16px;"><div><a href="#searchbox" class=""><span class="icon-salient-search" aria-hidden="true"></span></a></div> </li>							
						</ul>
							<div class="tgi_mobile_menu_icon"> <a href="#sidewidgetarea" class="closed"> <span> <i class="lines-button x2"> <i class="lines"></i> </i> </span> </a> </div> 
   					</div>
					<?php } ?>
